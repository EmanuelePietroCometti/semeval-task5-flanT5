...
def main():
    ...
    argparser.add_argument("--ce_weight", type=float, default=0.1, help="Peso per la CrossEntropy nella loss combinata")
    argparser.add_argument("--mse_weight", type=float, default=0.9, help="Peso per la MSE nella loss combinata")
